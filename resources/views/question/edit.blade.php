                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>{{ __('Edit Trivia Questions')}}</h4>
                        </div>
                            ...
                            <form action="{{ route('question.update')}}" method="post">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <textarea class="summernote-simple" name="question" required>{{ $question->question }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" class="form-control inputtags" value="{{ $question->options }}" name="options" required>
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <button class="btn btn-primary" type="submit">{{ __('Update Question')}}</button>
                                    </div>
                                </div>
                            </form>
                        </div>
